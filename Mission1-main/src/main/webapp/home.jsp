...
<%@ page import="com.zerobase.test1.controller.WifiService" %>
<%@ page import="com.zerobase.test1.controller.HistoryService" %>
<%@ page import="com.zerobase.test1.db.WifiData" %>
<%@ page import="com.zerobase.test1.db.HistoryData" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
